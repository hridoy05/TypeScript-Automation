import {ChattogramPage} from '../Pages/ChattogramPage'
...
describe("test dhaka page of birkroy.com",()=> {
    ...
    it('find date text', async() => {
        ...
        await chattogramPage.do_find_lowest_value(testData.locator.lowest_add_value)
        await chattogramPage.do_click_lowest_value(testData.locator.lowest_add_value)
        let ele = await chattogramPage.find_date_text(testData.locator.date_text)
    ...
    it('find element text', async() => {
        ...
        await chattogramPage.do_find_lowest_value(testData.locator.lowest_add_value)
        await chattogramPage.do_click_lowest_value(testData.locator.lowest_add_value)
        let text = await chattogramPage.find_element_text(testData.locator.element_text)
